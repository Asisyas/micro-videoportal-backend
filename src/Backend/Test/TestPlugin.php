...
use App\Backend\Test\Command\AuthTokenGenerateCommand;
...
use App\Backend\Test\Command\VideoChannelCreateCommand;
...
class TestPlugin extends AbstractPlugin implements CommandProviderInterface
{
    ...
    public function provideConsoleCommands(Container $container): array
    {
        return [
            ...
            new AuthTokenGenerateCommand($container->get(SecurityFacadeInterface::class)),
            new VideoChannelCreateCommand($container->get(VideoChannelClientInterface::class)),
